# Striver DSA Patterns – Part 2 (Problems 11–22)

This folder contains solutions for **Striver’s DSA Pattern Series – Patterns 11 to 22**.  
These patterns focus on **number logic, symmetry, spacing, and advanced loop control**.

Practicing these patterns helps build a strong foundation for:
- Nested loops
- Mathematical thinking
- Row–column relationships
- Problem-solving skills required for DSA
...
### 🔹 Pattern 19 – Symmetric Star Pattern
...
## 🎯 Goal
The goal of this folder is to **master loop logic and pattern thinking**, which directly helps in:
- DSA problem solving
...
## 📌 Note
More pattern variations and implementations may be added in the future.
